...
## Examples
An example of how to run the closed-loop experiments is in the file "closed-loop example.ipynb". You can also get the results from this Jupyter notebook. The final results will be written in the "./Closed_loop/Results/test_data.txt".
